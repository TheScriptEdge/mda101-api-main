...
<head><link href="./css/main.css?20240720" rel="stylesheet" type="text/css" /><link href="./css/ddsmoothmenu.css" rel="stylesheet" type="text/css" />
    ...
    <!-- End bottomBar -->
    <title>
	מערכת מתנדבי מרחב ירושלים - הודעות
</title>
    <link rel="stylesheet" type="text/css" href="./css/messaging.css" />

</head>
<body class="siteBody">
    <form name="aspnetForm" method="post" action="./MessagesFolder.aspx" id="aspnetForm">
<div>
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="B43D738B" />
	<input type="hidden" name="__PREVIOUSPAGE" id="__PREVIOUSPAGE" value="x3Cr7j1zkFMAnmU-zFtzL27q9n7scl9Tay96nb8KIWBcHH1c45mn3jEmuiB0o6qudgA4a7qAfY4LWpPZcqmCOd-gpj_9PE-D6u8G4LCZxxw1" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div>
        <script type="text/javascript">
//<![CDATA[
...
//]]>
        ...
        או <a href="/cdn-cgi/l/email-protection#1a7e7b6c737e5a7e767e79347975347376"><span class="__cf_email__" data-cfemail="026663746b6642666e66612c616d2c6b6e">[email&#160;protected]</span></a> <b>שימו לב:</b> בבעיות בנושא האתר יש לפתוח פניה <b>(המספר הינו לתמיכה טכנית בלבד. ש לשלוח וואטסאפ ולא להתקשר. לכל נושא אחר נא התקשרו למשרד מתנדבים.)</b>]
        </div>
    ...
    <div class="msgMenu">
        <ul>
            <li><a href="./MessagesCompose.aspx">כתוב הודעה</a></li>
            <li><a href="./MessagesFolder.aspx">דואר נכנס</a></li>
            
        </ul>
    </div>
    <div id="msgWrapper" class="RTLDiv conversationsWrapper rfloat">
        <ul id="ulConversationList">אין לך הודעות, <a href='./MessagesCompose.aspx' class='bold'>שלח הודעה למישהו</a>...</ul>        
    </div>
