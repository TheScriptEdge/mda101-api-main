...
function initNagishLi() {
    ...
    function f(a, d, e) {
        ...
        f = localStorage.getItem("Localize-NagishLi-A11y-Plugin-Settings") ? localStorage.getItem("Localize-NagishLi-A11y-Plugin-Settings") : JSON.stringify(f);
        f = JSON.parse(f);
        ...
        if (-1 !== ["change", "read", "delete"].indexOf(a)) {
            if ("read" == a)
                return "object" === typeof e && (f[d] = f[d].charAt(e.pos)),
                f[d];
            "change" == a ? (f[d] = "object" === typeof e ? f[d].substring(0, e.pos) + e.to + f[d].substring(e.pos + 1) : e,
            localStorage.setItem("Localize-NagishLi-A11y-Plugin-Settings", JSON.stringify(f))) : "delete" == a && localStorage.removeItem("Localize-NagishLi-A11y-Plugin-Settings")
        } else
            return !1
    }
    var K, x = "0", O = "0", C, d, e;
    ...
    var P = "undefined" != typeof nl_color && /^(blue|red|green|purple|yellow|pink|gray|brown|orange|turquoise|black)$/i.test(nl_color) ? nl_color.toLowerCase() : "blue";
    ...
    if (!K && m) {
        var p = !1
          ...
          , u = !1
          , z = !1;
        -1 != m.indexOf("|") ? (m = nl_contact.split("|"),
    ...
    $NagishLi(function(a) {
        function m(b, c) {
            ...
            if (a("body").attr("nl-colors") != c) {
                ...
                a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLcolorPanel > li.selected").removeClass("selected"),
                a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr("value", h(a("body").css("background-color"))),
                a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr("value", h(a("body").css("color"))),
                a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.clr_custom + "']").attr("aria-label", phrases.aria_select_bgcolor).css("background-color", a("body").css("background-color")),
                a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "']").attr("aria-label", phrases.aria_select_txtcolor).css("color", a("body").css("color"))),
                ...
                b)
                    return a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors").attr("aria-label", phrases.aria_the_option + phrases.blind + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                    a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.blind + "</span>").insertAfter(a(commons.dd + " > #NagishLiColors").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")),
                    !1
            } else
        ...
        function k(b, c) {
            ...
            if (a("body").attr("nl-colors") != c) {
                ...
                a("body").attr("nl-colors", c),
                b)
                    return a(commons.dd + " > #NagishLiColors > li > #NLInvertColors").attr("aria-label", phrases.aria_the_option + phrases.impaired + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                    a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.impaired + "</span>").insertAfter(a(commons.dd + " > #NagishLiColors").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")),
                    !1
            } else
                a("body").removeAttr("nl-colors"),
                a("html").css("height", ""),
        ...
        function u(b, c) {
            ...
            if (a("body").attr("nl-colors") != b) {
                ...
                if (c)
                    return "warm" == b ? (a(commons.dd + " > #NagishLiColors > li > #NLWarmColors").attr("aria-label", phrases.aria_the_option + phrases.bl_filter + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                    ...
                    a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.lc_filter + "</span>").insertAfter(a(commons.dd + " > #NagishLiColors").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title"))),
                    !1
            } else
                a("body").removeAttr("nl-colors"),
                a("html").css("height", ""),
        ...
        function p(b, c) {
            ...
            if (a("body").attr("nl-colors") != c) {
                ...
                a("body").attr("nl-colors", c),
                b)
                    return a(commons.dd + " > #NagishLiColors > li > #NLSaturateColors").attr("aria-label", phrases.aria_the_option + phrases.saturated + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                    a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.saturated + "</span>").insertAfter(a(commons.dd + " > #NagishLiColors").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")),
                    !1
            } else
                a("body").removeAttr("nl-colors"),
                a("html").css("height", ""),
        ...
        function v(b, c, d, e, l) {
            ...
            d = void 0 === d ? !1 : d;
            A && (l = f("read", "colors"),
            -1 !== l.indexOf(",") ? (e = 1 < l.split(",")[0].length ? l.split(",")[0] : "-",
            l = 1 < l.split(",")[1].length ? l.split(",")[1] : "-") : l = e = "-");
            d ? (a("body").attr("nl-colors", "custom"),
            d = {
            ...
            "bg" == b ? (b = "he" == g ? "undefined" !== typeof d[h(c)] ? phrases.bg + " " + d[h(c)] : d.custom : "undefined" !== typeof d[h(c)] ? d[h(c)] + " " + phrases.bg.toLowerCase() : d.custom,
            ...
            }).attr("aria-label", b)) : (b = "he" == g ? "undefined" !== typeof d[h(c)] ? phrases.txt + " " + d[h(c)] : d.custom : "undefined" !== typeof d[h(c)] ? d[h(c)] + " " + phrases.txt.toLowerCase() : d.custom,
            a("*").not(commons.not).each(function() {
                for (var b = a(this).length; b--; )
            ...
            a("div#NLCustomColors").children("span.sign").length || (a(commons.dd + " > #NagishLiColors > li.active > #NLNormalColors").children("span.sign").remove(),
            a(commons.dd + " > #NagishLiColors > li.active > #NLNormalColors").parent("li.active").removeClass("active"),
            a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors").parent("li.not-clickable").addClass("active"),
            a(commons.checkmark).prependTo(a("div#NLCustomColors")),
            a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.custom_colors + "</span>").insertAfter(a(commons.dd + " > #NagishLiColors").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")))) : a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel > li.selected").length ? ("custom" != a("body").attr("nl-colors") && (a("html").css("height", ""),
            a(":root").css({
                filter: "",
                "-webkit-filter": "",
                "-moz-filter": "",
            ...
            c = a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel > li.selected").css("background-color"),
            ...
            l = h(c)),
            f("change", "colors", e + "," + l)) : ("bg" == b ? (a("*").not(commons.not).each(function() {
                for (var b = a(this).length; b--; )
                    a(this)[b].style.setProperty("background-color", "", "")
            }),
        ...
        function z(b) {
            ...
            a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr("value", h(a("body").css("background-color"))),
            a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr("value", h(a("body").css("color"))),
            a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.clr_custom + "']").removeClass("selected").attr("aria-label", phrases.aria_select_bgcolor).css("background-color", a("body").css("background-color")),
            a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "']").removeClass("selected").attr("aria-label", phrases.aria_select_txtcolor).css("color", a("body").css("color"))) : (a("html").css("height", ""),
            a(":root").css({
                filter: "",
                "-webkit-filter": "",
                "-moz-filter": "",
        ...
        function R(b) {
            ...
            b = f("read", "text")) : (b = 16 != parseInt(a("body").css("font-size")) ? parseInt(a("body").css("font-size")) : 16,
            b += 1);
            var c = b;
            a("*").not(commons.not).each(function() {
                for (var b = a(this).length; b--; )
        ...
        function I(b) {
            b = void 0 === b ? "0" : b;
            a("body[nl-text]").length && (a("body").removeAttr("nl-text"),
            a("*").not(commons.not).each(function() {
                for (var b = a(this).length; b--; )
                    a(this)[b].style.setProperty("font-size", "", ""),
                    "0px" == a(this).css("font-size") && a(this)[b].style.setProperty("font-size", "initial", "")
            }),
        ...
        function Y(b) {
            ...
            if ("text" != a("body").attr("nl-display")) {
                ...
                c = "normal";
            if (b)
                return a("" + commons.dd + " > #NagishLiDisplay > li > #NLTextDisplay").attr("aria-label", phrases.aria_the_option + phrases.text_only + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                a("" + commons.dd + " > #NagishLiDisplay").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.text_only + "</span>").insertAfter(a("" + commons.dd + " > #NagishLiDisplay").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")),
                !1;
            f("change", "display", c)
        }
        function aa(b, c) {
            "images" != a("body").attr("nl-display") ? (a("body").attr("nl-display", "images"),
            Z(),
            a("link[rel='stylesheet']").prop("disabled") && a("link[rel='stylesheet']").prop("disabled", !1),
            ...
            c = "normal");
            if (b)
                return a(commons.dd + " > #NagishLiDisplay > li > #NLImagesDisplay").attr("aria-label", phrases.aria_the_option + phrases.images_only + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                a(commons.dd + " > #NagishLiDisplay").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.images_only + "</span>").insertAfter(a(commons.dd + " > #NagishLiDisplay").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")),
                !1;
            f("change", "display", c)
        }
        function ba(b) {
            b = void 0 === b ? "normal" : b;
            a("body[nl-display]").length && (a("body").removeAttr("nl-display"),
            a("link[rel='stylesheet']").prop("disabled") && a("link[rel='stylesheet']").prop("disabled", !1),
        ...
        function T(b) {
            b ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks").attr("aria-label", phrases.aria_the_option + phrases.hl_links + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active"),
            a("* a").not("#NagishLiBar a").each(function() {
        ...
        function U(b) {
            ...
            b = "0") : (a("h1, h2, h3, h4, h5, h6, h1").each(function() {
                this.style.setProperty("outline", "3px red dotted", "important");
                this.style.setProperty("background", "black", "important");
                this.style.setProperty("color", "yellow", "important")
            }),
        ...
        function ca(b) {
            if ("zoom"in document.documentElement.style)
                b ? (b = f("read", "zoom"),
                b = +b) : (b = a("body[style*='zoom']").length ? -1 !== a("body").css("zoom").indexOf("%") ? parseInt(a("body").css("zoom")) / 100 : parseFloat(a("body").css("zoom")) : 1,
                b = +(b + .1).toFixed(1)),
                a("body").css("zoom", b),
                a("body > iframe").css({
                ...
                b ? (b = f("read", "zoom"),
                b = +b) : (a("body[style*='transform: scale']").length ? (b = a("body").css("transform").match(/-?[\d\.]+/g),
                ...
                return alert(phrases.not_supported),
                !1;
            f("change", "zoom", b);
        ...
        function da(b) {
            if ("zoom"in document.documentElement.style)
                ...
                !1;
            f("change", "zoom", b);
            1 >= b && "absolute" == a(commons.bar).css("position") && (a("html")[0].style.setProperty("overflow-y", "", ""),
        ...
        function fa(b, c) {
            ...
            c = void 0 === c ? !1 : c;
            a("body[nl-font]").length ? (a("body").removeAttr("nl-font"),
            a("body *").not(commons.not).each(function() {
                this.style.setProperty("font-family", "", "")
            }),
            a(commons.dd + " > #NagishLiMisc > li > #NLFont > #NLFontVal").text(phrases.normal),
            b = "normal") : (a("body").attr("nl-font", "readable"),
            a("body *").not(commons.not).each(function() {
        ...
        function y(b, c) {
            "TL" == b ? (a(commons.bar)[0].style.setProperty("top", "0vh", "important"),
            ...
            })) : "BR" == b ? (a(commons.bar)[0].style.setProperty("bottom", "0vh", "important"),
            ...
            })) : "TR" == b ? (a(commons.bar)[0].style.setProperty("bottom", "auto", "important"),
            a(commons.bar)[0].style.setProperty("top", "0vh", "important"),
            a(commons.bar)[0].style.setProperty("right", "0", "important"),
            a(commons.bar)[0].style.setProperty("left", "auto", "important"),
            "he" == g && a("span#NagishLiMove > span").each(function() {
                a(this).attr("data-balloon-pos", phrases.align_left)
            })) : "BL" == b && (a(commons.bar)[0].style.setProperty("bottom", "0vh", "important"),
            a(commons.bar)[0].style.setProperty("top", "auto", "important"),
            a(commons.bar)[0].style.setProperty("right", "auto", "important"),
            a(commons.bar)[0].style.setProperty("left", "0", "important"),
            "he" == g && a("span#NagishLiMove > span").each(function() {
        ...
        function ha(b, c) {
            b = void 0 === b ? !1 : b;
            c = void 0 === c ? "off" : c;
            a("body[nl-animations]").length || "off" != c ? (jQuery.fx.off = !1,
            a("body *").not(commons.not).each(function() {
            ...
            a(commons.dd + " > #NagishLiMisc > li > #NLAnimations > #NLAnimationsVal")[0].innerHTML = '<span aria-hidden="true">&#x275a;&#x275a;&nbsp;</span>' + phrases.animations_off);
        ...
        function ia(b, c) {
            ...
            if (a("body[nl-r2m]").length || a("body span.r2m").length || "off" != c)
                ...
                X || !b && (a(commons.bar + " > #nlr2mp").length || a(commons.bar + " > #nlr2ms").length) || (ma(q + "/sfx/male/" + g + "_digits.js", "nlr2ms"),
                a("nagishli").append('<audio crossorigin="anonymous" id="nlr2mp" style="display: none !important;">' + phrases.not_supported + "</audio>"),
        ...
        function L(b, c) {
            b = void 0 === b ? "black" : b;
            c = void 0 === c ? !1 : c;
            a("html[nl-cursor]").length && a("html").attr("nl-cursor") == b ? (a(":root").removeAttr("nl-cursor"),
            b = "normal") : a(":root").attr("nl-cursor", b);
            if (c)
                return "black" == b ? a(commons.checkmark).prependTo(a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorBlack").attr("aria-label", phrases.aria_the_option + phrases.cursor + " " + phrases.cursor_black + " " + phrases.r2m_on).addClass("active")) : a(commons.checkmark).prependTo(a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorWhite").attr("aria-label", phrases.aria_the_option + phrases.cursor + " " + phrases.cursor_white + " " + phrases.r2m_on).addClass("active")),
                !1;
            f("change", "cursor", b)
        }
        function ja() {
        ...
        function Z() {
            a("[nl-role*='media']").length && (a("iframe[src*='youtube.com']").each(function() {
                for (var b = a(this).length; b--; )
                    "ytmedia" == a(this).attr("nl-role") ? (a("iframe[src*='youtube.com']")[b].contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"),
                    a(this).attr("nl-role", "ytmedia-paused")) : a(this).attr("nl-role", "ytmedia")
            }),
            a("video, audio").each(function() {
                for (var b = a(this).length; b--; )
                    "media" == a(this).attr("nl-role") ? (a("video, audio")[b].pause(),
                    a(this).attr("nl-role", "media-paused")) : a(this).attr("nl-role", "media")
            }))
        }
        ...
        if (!a("body").length)
            throw alert(phrases.body_missing),
            Error(phrases.body_missing);
        if (A) {
            var w = function(a) {
                if ("string" != typeof a)
                    return !1;
            ...
            if (J.major < w.major || J.minor < w.minor || J.patch < w.patch)
                ...
                a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus, " + commons.bar + " > #NagishLiBarStrip > #NagishLiMove").remove(),
                a(commons.bar + " > #NagishLiBarStrip").addClass("open"),
                a(commons.menus).show(),
                a(commons.menus).html('<li class="nl-dropdown"><ul class="nl-dropdown-menu show"><li class="not-clickable"><div href="#">' + phrases.settings_upgrade_html + "</div></li></ul></li>"),
                !1
        }
        !function(a, c) {
            ...
            function g(a, b, c) {
                if (b.scope === c || "all" === b.scope) {
                    for (var d in c = 0 < b.mods.length,
                    t)
                        Object.prototype.hasOwnProperty.call(t, d) && (!t[d] && -1 < b.mods.indexOf(+d) || t[d] && !~b.mods.indexOf(+d)) && (c = !1);
                    (0 !== b.mods.length || t[16] || t[18] || t[17] || t[91]) && !c && "*" !== b.shortcut || !1 === b.method(a, b) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1,
                ...
                if (m.filter.call(this, a)) {
                    ...
                    if (b)
                        for (e = 0; e < b.length; e++)
                            b[e].scope === d && ("keydown" === a.type && b[e].keydown || "keyup" === a.type && b[e].keyup) && g(a, b[e], d);
                    if (c in r)
                        for (b = 0; b < r[c].length; b++)
                            if (("keydown" === a.type && r[c][b].keydown || "keyup" === a.type && r[c][b].keyup) && r[c][b].key) {
                                e = r[c][b].key.split("+");
            ...
            function m(b, e, f) {
                ...
                "[object Object]" === Object.prototype.toString.call(e) && (e.scope && (F = e.scope),
                ...
                void 0 === B || -1 < w.indexOf(B) || !window || (w.push(B),
            ...
            k = {
                ...
                filter: function(a) {
                    ...
                    var b = a.tagName
                      , c = !0;
                    return !a.isContentEditable && "TEXTAREA" !== b && ("INPUT" !== b && "TEXTAREA" !== b || a.readOnly) || (c = !1),
                    c
                },
                unbind: function(a, b, e) {
                    ...
                    b = "all");
                    for (var k = 0; k < B.length && (g = 1 < (l = B[k].split("+")).length ? c(q, l) : [],
            ...
            if ("undefined" != typeof window) {
                ...
                m.noConflict = function(a) {
                    return a && window.hotkeys === m && (window.hotkeys = A),
                    m
                }
                ;
                window.hotkeys = m
        ...
        d += '<div class="nl-dropdown-toggle" tabindex="10"><span class="nl-dropdown-title">' + phrases.settings + '</span><span class="nagishli-sr-only" aria-live="assertive" aria-hidden="true">' + phrases.aria_toggle_open_alt + phrases.settings + "</span></div>";
        d += '<ul id="NagishLiInfo" class="nl-dropdown-menu">';
        d += '<li><div id="NagishLiStatement" tabindex="11"><span class="help" data-balloon="' + phrases.a11y_info_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.a11y_info_exp + '</span><span class="nagishli-option-title">' + phrases.a11y_info + "</span></div></li>";
        ...
        d += '<li><div id="NagishLiKeyboardShortcutsInfo" tabindex="12"><span class="help" data-balloon="' + phrases.kbshortcuts_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.kbshortcuts_exp + '</span><span class="nagishli-option-title">' + phrases.kbshortcuts + "</span></div></li>";
        d += '<li class="not-clickable"><div tabindex="13" data-balloon-length="large" data-balloon="' + phrases.supported_browsers_exp + '" data-balloon-pos="up"><span id="NagishLiSupportedBrowsers">' + phrases.supported_browsers + ':<span aria-label="' + phrases.chrome + '" style="background: ' + icons.chrome + ';"></span><span aria-label="' + phrases.edge + '" style="background: ' + icons.edge + ';"></span><span aria-label="' + phrases.firefox + '" style="background: ' + icons.firefox + ';"></span><span aria-label="' + phrases.opera + '" style="background: ' + icons.opera + ';"></span><span aria-label="' + phrases.explorer + '" style="background: ' + icons.explorer + ';"></span></span></div></li>';
        d += '<li id="NagishLiHelp">';
        d += '<div id="NLToggleHelp" tabindex="14">';
        d += '<span class="nagishli-sr-only" aria-hidden="true">' + phrases.help_exp + '</span><span class="nagishli-option-title">' + phrases.help + "</span>";
        d += "</div>";
        d += "</li>";
        A && (d += "<li>",
        d += '<div id="NLResetSettings" tabindex="15"><span class="help" data-balloon="' + phrases.reset_settings_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.reset_settings_exp + '</span><span class="nagishli-option-title">' + phrases.reset_settings + "</span></div>",
        d += "</li>");
        if ("0" == O || "" != Q && D != oa)
            d += '<li id="NagishLiDeveloper" class="not-clickable">',
            d += "<div>",
            d += '<a href="http://www.nagish.li" target="_blank" style="border-bottom: 1px dashed !important;" title="' + phrases.branding_exp + '" tabindex="16">' + phrases.branding + "</a> " + phrases.developed_by + ' <a href="http://www.localize.co.il" target="_blank" title="' + phrases.developer_exp + '" tabindex="16">' + phrases.developer + '<sup style="font-size: 65% !important;" aria-hidden="true">&#x2731;</sup></a>',
            d += '<a href="' + phrases.developed_in_link + '" target="_blank" id="NLDevelopedIn" data-balloon="' + phrases.developed_in + '" data-balloon-pos="' + phrases.align_right + '" tabindex="16"><span aria-hidden="true" style="background: ' + icons.sod + '; display: inline-block !important;"></a>',
            d += "</div>",
            d += "</li>";
        d += "</ul>";
        d += "</li>";
        ...
        d += "</li>";
        d += "<li>";
        d += '<div id="NLSmallerText" tabindex="22"><span class="help" data-balloon="' + phrases.smaller_text_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.smaller_text_exp + '</span><span class="nagishli-option-title">' + phrases.smaller_text + "</span></div>";
        d += "</li>";
        d += "<li>";
        ...
        d += "</li>";
        d += '<li class="nl-dropdown">';
        d += '<div class="nl-dropdown-toggle" tabindex="30"><span class="nl-dropdown-title">' + phrases.colors + '</span><span class="nagishli-sr-only" aria-live="assertive" aria-hidden="true">' + phrases.aria_toggle_open_alt + phrases.colors + "</span></div>";
        d += '<ul id="NagishLiColors" class="nl-dropdown-menu">';
        qa || (d += "<li>",
        d += '<div id="NLGrayscaleColors" tabindex="31"><span class="help" data-balloon="' + phrases.blind_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.blind_exp + '</span><span class="nagishli-option-title">' + phrases.blind + "</span></div>",
        d += "</li>",
        d += "<li>",
        d += '<div id="NLInvertColors" tabindex="32"><span class="help" data-balloon="' + phrases.impaired_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.impaired_exp + '</span><span class="nagishli-option-title">' + phrases.impaired + "</span></div>",
        d += "</li>",
        d += "<li>",
        d += '<div id="NLWarmColors" tabindex="33"><span class="help" data-balloon="' + phrases.bl_filter_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.bl_filter_exp + '</span><span class="notice" data-balloon="' + phrases.experimental_feat + '" aria-hidden="true">' + commons.warning + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.experimental_feat + '</span><span class="nagishli-option-title">' + phrases.bl_filter + "</span></div>",
        d += "</li>",
        d += "<li>",
        d += '<div id="NLColdColors" tabindex="34"><span class="help" data-balloon="' + phrases.lc_filter_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.lc_filter_exp + '</span><span class="notice" data-balloon="' + phrases.experimental_feat + '" aria-hidden="true">' + commons.warning + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.experimental_feat + '</span><span class="nagishli-option-title">' + phrases.lc_filter + "</span></div>",
        d += "</li>",
        d += "<li>",
        d += '<div id="NLSaturateColors" tabindex="35"><span class="help" data-balloon="' + phrases.saturated_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.saturated_exp + '</span><span class="notice" data-balloon="' + phrases.experimental_feat + '" aria-hidden="true">' + commons.warning + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.experimental_feat + '</span><span class="nagishli-option-title">' + phrases.saturated + "</span></div>",
        d += "</li>");
        if (null != a("body").css("background-color") || null != a("body").css("color"))
            d += '<li class="not-clickable">',
            d += '<div id="NLCustomColors"><span class="help" data-balloon="' + phrases.custom_colors_exp + '" tabindex="35">' + commons.help + '&nbsp;</span><span class="nagishli-option-title">' + phrases.custom_colors + "</span>:&nbsp;" + (null != a("body").css("background-color") && "rgba(0, 0, 0, 0)" != a("body").css("background-color") ? '<span id="NLCustomColorsBG" tabindex="35"><span id="NLCurrentBG" style="display: none;"></span>' + phrases.bg + "</span>&nbsp;" : "") + (null != a("body").css("color") && "rgba(0, 0, 0, 0)" != a("body").css("color") ? '<span id="NLCustomColorsTXT" tabindex="35"><span id="NLCurrentTXT" style="display: none;"></span>' + phrases.txt + "</span></div>" : ""),
            d += "</li>";
        d += '<li class="active">';
        ...
        d += "</li>";
        d += "<li>";
        d += '<div id="NLImagesDisplay" tabindex="42"><span class="help" data-balloon="' + phrases.images_only_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.images_only_exp + '</span><span class="nagishli-option-title">' + phrases.images_only + "</span></div>";
        d += "</li>";
        d += '<li class="active">';
        ...
        d += "</li>";
        d += '<li class="nl-dropdown">';
        d += '<div class="nl-dropdown-toggle" tabindex="50"><span class="nl-dropdown-title">' + phrases.highlight + '</span><span class="nagishli-sr-only" aria-live="assertive" aria-hidden="true">' + phrases.aria_toggle_open_alt + phrases.highlight + "</span></div>";
        ...
        d += "</li>";
        d += "<li>";
        d += '<div id="NLHighlightHeadings" tabindex="52"><span class="help" data-balloon="' + phrases.hl_headings_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="nagishli-sr-only" aria-hidden="true">' + phrases.hl_headings_exp + '</span><span class="nagishli-option-title">' + phrases.hl_headings + "</span></div>";
        d += "</li>";
        d += "</ul>";
        d += "</li>";
        d += '<li class="nl-dropdown">';
        d += '<div class="nl-dropdown-toggle" tabindex="60"><span class="nl-dropdown-title">' + phrases.misc + '</span><span class="nagishli-sr-only" aria-live="assertive" aria-hidden="true">' + phrases.aria_toggle_open_alt + phrases.misc + "</span></div>";
        ...
        d += '<select id="NLSkipLinksVal" tabindex="61"><option aria-hidden="true" value="none" disabled selected>' + phrases.skiplinks_default + '</option><optgroup label="' + phrases.skiplinks_page_nav + '"><option value="top">' + phrases.skiplinks_to_top + '</option><option value="menu">' + phrases.skiplinks_to_menu + '</option><option value="header">' + phrases.skiplinks_to_header + '</option><option value="paragraph">' + phrases.skiplinks_to_paragraph + '</option><option value="content">' + phrases.skiplinks_to_content + '</option><option value="bottom">' + phrases.skiplinks_to_bottom + '</option></optgroup><optgroup label="' + phrases.skiplinks_site_nav + '"><option value="home">' + phrases.skiplinks_to_home + "</option></optgroup></select>";
        d += "</li>";
        d += '<li class="not-clickable">';
        d += '<div id="NLZoom"><span class="help" data-balloon="' + phrases.zoom_exp + '" aria-hidden="true">' + commons.help + "&nbsp;</span>" + phrases.zoom + ':&nbsp;<span id="NLZoomVal" aria-live="assertive"></span><span id="NLZoomIn" tabindex="63"><span aria-hidden="true">&#x2795;&#xfe0e;</span><span class="nagishli-sr-only">' + phrases.zoom_in + '</span></span>&nbsp;&nbsp;<span id="NLZoomOut" tabindex="63"><span aria-hidden="true">&#x2796;&#xfe0e;</span><span class="nagishli-sr-only">' + phrases.zoom_out + '</span></span>&nbsp;&nbsp;<span id="NLNormalZoom" tabindex="63"><span class="nagishli-sr-only">' + phrases.zoom + " </span>" + phrases.normal + "</span></div>";
        d += "</li>";
        d += "<li>";
        ...
        d += "</li>";
        d += "<li>";
        d += '<div id="NLAnimations" tabindex="65"><span class="help" data-balloon="' + phrases.animations_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="notice" data-balloon="' + phrases.experimental_feat + '" aria-hidden="true">' + commons.warning + "&nbsp;</span>" + phrases.animations + ':&nbsp;<span id="NLAnimationsVal" aria-live="assertive"><span aria-hidden="true">&#x25ba;&#xfe0e;&nbsp;</span>' + phrases.animations_on + "</span></div>";
        d += "</li>";
        d += "<li>";
        d += '<div id="NLR2M" tabindex="67"><span class="help" data-balloon="' + phrases.r2m_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="notice" data-balloon="' + phrases.experimental_feat + '" aria-hidden="true">' + commons.warning + "&nbsp;</span>" + phrases.r2m + ':&nbsp;<span id="NLR2MVal" aria-live="assertive">' + phrases.r2m_off + "</span></div>";
        d += "</li>";
        d += '<li class="not-clickable">';
        d += '<div id="NLCursor"><span class="help" data-balloon="' + phrases.cursor_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="notice" data-balloon="' + phrases.experimental_feat + '" aria-hidden="true">' + commons.warning + "&nbsp;</span>" + phrases.cursor + ':&nbsp;<span id="NLCursorBlack" tabindex="68">' + phrases.cursor_black + '</span>&nbsp;<span id="NLCursorWhite" tabindex="68">' + phrases.cursor_white + "</span></div>";
        d += "</li>";
        d += "<li>";
        d += '<div id="NLKBNav" tabindex="70"><span class="help" data-balloon="' + phrases.kbnav_exp + '" aria-hidden="true">' + commons.help + '&nbsp;</span><span class="notice" data-balloon="' + phrases.experimental_feat + '" aria-hidden="true">' + commons.warning + "&nbsp;</span>" + phrases.kbnav + ':&nbsp;<span id="NLKBNavVal" aria-live="assertive">' + phrases.kbnav_off + "</span></div>";
        d += "</li>";
        d += "</ul>";
        d += "</li>";
        d += "</ul>";
        ...
        e += "* nagishli#NagishLiTag select option { color: #6f6f6f !important; background: #EEE !important; }";
        ...
        e += commons.menus + " { list-style: none !important; display: none; padding: 0 !important; margin: 0 !important; width: 100% !important; min-width: 345px !important; max-height: " + (a(window).height() - 41) + "px; overflow-x: hidden !important; height: 100%; }";
        ...
        e += commons.dd + " > .nl-dropdown-menu > li > div, " + commons.dd + ":last-child > .nl-dropdown-menu > li:last-child > div, " + commons.menus + ".blue > .nl-dropdown > .nl-dropdown-menu > li > div, " + commons.menus + ".blue > .nl-dropdown:last-child > .nl-dropdown-menu > li:last-child > div { border-color: #5478E4 !important; }";
        ...
        e += commons.menus + ".yellow > .nl-dropdown > .nl-dropdown-menu > li > div, " + commons.menus + ".yellow > .nl-dropdown:last-child > .nl-dropdown-menu > li:last-child > div { border-color: #EDCA19 !important; }";
        ...
        e += commons.menus + ".yellow > .nl-dropdown > .nl-dropdown-toggle:hover, " + commons.menus + ".yellow::-webkit-scrollbar-thumb:active, #NagishLiOverlayContent.yellow::-webkit-scrollbar-thumb:active { background: #EDCA19 !important; }";
        ...
        e += commons.menus + ".orange > .nl-dropdown > .nl-dropdown-menu > li > div, " + commons.menus + ".orange > .nl-dropdown:last-child > .nl-dropdown-menu > li:last-child > div { border-color: #FF8C00 !important; }";
        ...
        e += commons.menus + ".orange > .nl-dropdown > .nl-dropdown-toggle:hover, " + commons.menus + ".orange::-webkit-scrollbar-thumb:active, #NagishLiOverlayContent.orange::-webkit-scrollbar-thumb:active { background: #FF9719 !important; }";
        ...
        e += commons.dd + " > .nl-dropdown-menu > li > div > #NLDevelopedIn { display: inline-block !important; position: absolute !important; " + phrases.align_left + ": 10px !important; top: 12px !important; }";
        H ? (e += commons.bar + " > #NagishLiBarStrip.open > #NagishLiMove { margin-" + phrases.align_left + ": 0 !important; }",
        e += commons.bar + " > #NagishLiBarStrip > #NagishLiMove { margin-" + phrases.align_right + ": 10px !important; }") : e += commons.bar + " > #NagishLiBarStrip.open > #NagishLiMove { margin-" + phrases.align_left + ": 30px !important; }";
        na && (e += commons.bar + " > #NagishLiBarStrip > #NagishLiTitle, " + commons.bar + " > #NagishLiBarStrip > #NagishLiMove, " + commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus  { display: none !important; }",
        e += commons.bar + " > #NagishLiBarStrip.open > #NagishLiTitle, " + commons.bar + " > #NagishLiBarStrip.open > #NagishLiMove, " + commons.bar + " > #NagishLiBarStrip.open > #NagishLiToggleMenus { display: inline-block !important; }",
        e += commons.bar + " > #NagishLiBarStrip > #NagishLiLogo { width: 25px !important; height: 25px !important; margin-" + phrases.align_right + ": 7px !important; }",
        e += commons.bar + " > #NagishLiBarStrip.open > #NagishLiLogo { width: 21px !important; height: 21px !important; margin-" + phrases.align_right + ": 0 !important; }");
        ...
        e += commons.dd + " > .nl-dropdown-menu > li > div > .notice { z-index: 9999997 !important; }",
        e += "* nagishli#NagishLiTag *[data-balloon]:before, * nagishli#NagishLiTag *[data-balloon]:after, body span.r2m[data-balloon]:before, body span.r2m[data-balloon]:after { -webkit-transition: none !important; -moz-transition: none !important; -ms-transition: none !important; -o-transition: none !important; transition: none !important; font-weight: bold !important;}");
        e += "nagishli#NagishLiTag > .NagishLiOverlay { position: fixed !important; top: 0 !important; " + phrases.align_left + ": 0 !important; width: 100% !important; height: 100% !important; background: rgba(0, 0, 0, 0.7) repeat !important; text-align: center !important; z-index: 9999999 !important; opacity: 1; }";
        ...
        e += 'html[nl-cursor="white"] * a:hover, html[nl-cursor="white"] * a:focus, html[nl-cursor="white"] * a:active, html[nl-cursor="white"] * a:visited { cursor: url(' + icons.white_pointer + ") 18 0, auto !important; }";
        ...
        if (A) {
            var la = function(b) {
                if (b = confirm(phrases.reset_prompt))
                    ...
                    a(commons.bar + " > #NagishLiBarStrip").addClass("open"),
                    a(commons.menus).show(),
                    a(commons.menus).html('<li class="nl-dropdown"><ul class="nl-dropdown-menu show"><li class="not-clickable"><div>' + phrases.settings_reset_html_ok + "</div></li></ul></li>"),
            ...
            if ("alt+z" == c.key || "shift+z" == c.key) {
                if (!a("#NagishLiOverlayContent").length) {
                    if (a(commons.menus).is(":visible")) {
                        ...
                        a(commons.bar + " > #NagishLiBarStrip").addClass("open").next("#NagishLiMenus").slideDown(150),
                        d = "open";
                    f("change", "menu", d)
                }
            } else
                "alt+x" == c.key || "shift+x" == c.key ? V() : "alt+v" == c.key || "alt+b" == c.key ? window.scrollTo(0, "alt+v" == c.key ? 0 : (document.scrollingElement || document.body).scrollHeight) : "shift+a" == c.key ? R() : "shift+s" == c.key ? S() : "shift+q" == c.key ? (m(),
                a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors > .sign").length ? (a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors > .sign").remove(),
                a(commons.dd + " > #NagishLiColors > li.active").removeClass("active"),
                a(commons.dd + " > #NagishLiColors > li > #NLNormalColors").addClass("active").prepend(commons.checkmark),
                a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").children(".selected").remove()) : (a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors").attr("aria-label", phrases.aria_the_option + phrases.blind + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").hasClass("open") || a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").children(".selected").length || a('<span class="selected">' + phrases.blind + "</span>").insertAfter(a(commons.dd + " > #NagishLiColors").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")))) : "shift+w" == c.key ? (k(),
                a(commons.dd + " > #NagishLiColors > li > #NLInvertColors > .sign").length ? (a(commons.dd + " > #NagishLiColors > li > #NLInvertColors > .sign").remove(),
                a(commons.dd + " > #NagishLiColors > li.active").removeClass("active"),
                a(commons.dd + " > #NagishLiColors > li > #NLNormalColors").addClass("active").prepend(commons.checkmark),
                a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").children(".selected").remove()) : (a(commons.dd + " > #NagishLiColors > li > #NLInvertColors").attr("aria-label", phrases.aria_the_option + phrases.impaired + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                ...
                a(commons.dd + " > #NagishLiColors > li.active").removeClass("active"),
                a(commons.dd + " > #NagishLiColors > li > #NLNormalColors").addClass("active").prepend(commons.checkmark),
                a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").children(".selected").remove()) : (a(commons.dd + " > #NagishLiColors > li > #NLSaturateColors").attr("aria-label", phrases.aria_the_option + phrases.saturated + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").hasClass("open") || a(commons.dd + " > #NagishLiColors").prev("div.nl-dropdown-toggle").children(".selected").length || a('<span class="selected">' + phrases.saturated + "</span>").insertAfter(a(commons.dd + " > #NagishLiColors").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")))) : "shift+d" == c.key ? (T(),
                a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks > .sign").length ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks > .sign").remove(),
                a(commons.dd + " > #NagishLiHighlight > li.active").removeClass("active"),
                a(commons.dd + " > #NagishLiHighlight").prev("div.nl-dropdown-toggle").children(".selected").remove()) : (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks").attr("aria-label", phrases.aria_the_option + phrases.hl_links + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                a(commons.dd + " > #NagishLiHighlight").prev("div.nl-dropdown-toggle").hasClass("open") || a(commons.dd + " > #NagishLiHighlight").prev("div.nl-dropdown-toggle").children(".selected").length || a('<span class="selected">' + phrases.hl_links + "</span>").insertAfter(a(commons.dd + " > #NagishLiHighlight").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")))) : "shift+f" == c.key && (U(),
                a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings > .sign").length ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings > .sign").remove(),
                a(commons.dd + " > #NagishLiHighlight > li.active").removeClass("active"),
                ...
                a(commons.dd + " > #NagishLiHighlight").prev("div.nl-dropdown-toggle").hasClass("open") || a(commons.dd + " > #NagishLiHighlight").prev("div.nl-dropdown-toggle").children(".selected").length || a('<span class="selected">' + phrases.hl_headings + "</span>").insertAfter(a(commons.dd + " > #NagishLiHighlight").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title"))));
            b.preventDefault()
        });
        ...
        A ? function() {
            ...
            if ("0" == b && ("0" != e && (8 >= parseInt(e) || 35 <= parseInt(e)) || "0.0" != h && (.5 >= parseFloat(h) || 2.5 <= parseFloat(h)) || -1 !== c.indexOf(",") && c.split(",")[0] == c.split(",")[1])) {
                ...
                if (1 == b)
                    ...
                    a(commons.bar + " > #NagishLiBarStrip").addClass("open"),
                    a(commons.menus).show(),
                    a(commons.menus).html('<li class="nl-dropdown"><ul class="nl-dropdown-menu show"><li class="not-clickable"><div href="#">' + phrases.settings_reset_html_ok + "</div></li></ul></li>"),
                    alert(phrases.settings_reset_alert_ok),
                    a(commons.menus + " a").focus(),
                    !1;
                0 == b && (f(name, "write", "ok", 1, "1"),
                alert(phrases.settings_save + "\n" + phrases.settings_save_reminder))
            }
            "open" == f("read", "menu") ? a("#NagishLiBarStrip").addClass("open").next("#NagishLiMenus").show() : a("#NagishLiMenus").hide();
            ...
            if (void 0 === n ? 0 : n)
                for (n = d.length; n--; )
                    d[n] == b && (a(commons.dd + " > .nl-dropdown-toggle").eq(n).addClass("open").next("ul.nl-dropdown-menu").show().addClass("show"),
                    a(commons.dd + " > .nl-dropdown-toggle").eq(n).children(".nl-dropdown-arrow").attr("aria-label", phrases.aria_toggle_close_alt + a(commons.dd + " > .nl-dropdown-toggle").eq(n).children(".nl-dropdown-title").text()));
            else
                for (n = d.length; n--; )
                    d[n] == b && (a(commons.dd + " > .nl-dropdown-toggle").eq(n).addClass("open").next("ul.nl-dropdown-menu").slideDown("fast").addClass("show"),
                    a(commons.dd + " > .nl-dropdown-toggle").eq(n).children(".nl-dropdown-arrow").attr("aria-label", phrases.aria_toggle_close_alt + a(commons.dd + " > .nl-dropdown-toggle").eq(n).children(".nl-dropdown-title").text()));
            ja();
            0 == parseInt(e) ? I() : 0 < parseInt(e) ? R(!0) : S(!0);
            "grayscale" == c ? m(!0) : "invert" == c ? k(!0) : "warm" == c ? u("warm", !0) : "cold" == c ? u("cold", !0) : "saturate" == c ? p(!0) : -1 !== c.indexOf(",") ? ("-" != c.split(",")[0] && v("bg", W(c.split(",")[0]), !0),
            "-" != c.split(",")[1] && v("txt", W(c.split(",")[1]), !0)) : z();
            "textonly" == l ? Y(!0) : "imagesonly" == l ? aa(!0) : ba();
            0 < parseFloat(h) ? ca(!0) : 0 > parseFloat(h) ? da(!0) : ea();
            "readable" == q && fa("readable", !0);
            "1" == w && T(!0);
            "1" == x && U(!0);
            !a("ul#NagishLiHighlight").prev(".nl-dropdown-toggle", "div").hasClass("open") && a("ul#NagishLiHighlight > li.active").length && (1 < a("ul#NagishLiHighlight > li.active").find("span.sign").length ? (c = a("ul#NagishLiHighlight").children("li.active:first-child").find(".nagishli-option-title").text() + " " + a("ul#NagishLiHighlight").children("li.active:nth-child(2)").find(".nagishli-option-title").text(),
            c = c.split(" "),
            c[1] = "en" == g ? c[1].charAt(0).toUpperCase() + c[1].substr(1) : c[1],
            a('<span class="selected">' + c[1] + "&nbsp;" + phrases.and + c[3] + "</span>").insertAfter(a("ul#NagishLiHighlight").prev(".nl-dropdown-toggle", "div").children(".nl-dropdown-title"))) : (c = a("ul#NagishLiHighlight > li.active").find(".nagishli-option-title").text(),
        ...
        a("body").on("mousedown keypress.nlkbnavclk", function(b) {
            !a(commons.menus).is(":visible") || a(b.target).is("#NagishLiBar, .NagishLiOverlay, a, span[nl-r2m-data], #NLCustomColorsTXT, #NLCustomColorsBG, #NLCloseColorPanel") || a(b.target).parents("#NagishLiBar, .NagishLiOverlay, a, span[nl-r2m-data]").length || (a(commons.menus).slideUp(150, function() {
                a(commons.bar + " > #NagishLiBarStrip").removeClass("open")
            }),
        ...
        a(commons.dd + " > .nl-dropdown-toggle").click(function(b, c) {
            ...
            H ? (a(commons.dd + " > .nl-dropdown-toggle").not(a(this)).removeClass("open").next("ul.nl-dropdown-menu").slideUp("fast").removeClass("show"),
            a(this).toggleClass("open").next("ul.nl-dropdown-menu").slideToggle("fast").toggleClass("show"),
            b = "000000",
            a(this).hasClass("open") && (b = b.substr(0, c) + "1" + b.substr(c + 1)),
            f("change", "submenus", b)) : (a(this).toggleClass("open").next("ul.nl-dropdown-menu").slideToggle("fast").toggleClass("show"),
            a(this).hasClass("open") ? (b = "1",
            a(this).children(".nl-dropdown-arrow").attr("aria-label", phrases.aria_toggle_close_alt + a(this).children(".nl-dropdown-title").text()),
            a(this).children(".nagishli-sr-only").text(phrases.aria_toggle_close_alt + a(this).children(".nl-dropdown-title").text())) : (b = "0",
            a(this).children(".nl-dropdown-arrow").attr("aria-label", phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text()),
            a(this).children(".nagishli-sr-only").text(phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text())),
            f("change", "submenus", {
                to: b,
                pos: c
            }));
        ...
        a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus").on("click keypress.nlkbnavclk", function(b, c) {
            ...
            a(commons.dd + " > .nl-dropdown-toggle").addClass("open").children("span.selected").remove(),
            a(commons.dd + " > .nl-dropdown-menu").slideDown("fast").addClass("show"),
            c = "111111",
            ...
            a(commons.dd + " > .nl-dropdown-menu.show").slideUp("fast").removeClass("show"),
            c = "000000",
            a(commons.dd + " > .nl-dropdown-toggle").each(function() {
                a(this).children(".nl-dropdown-arrow").attr("aria-label", phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text());
                if (a(this).next("#NagishLiColors, #NagishLiDisplay", "ul").children("li.active:not(':last-child')").length) {
                    ...
                    a(this).next("#NagishLiHighlight", "ul").length && (!a(this).children("span.selected").length && 1 < a(this).next("ul").children("li.active").find("span.sign").length ? (b = a(this).next("ul").children("li.active:first-child").find(".nagishli-option-title").text() + " " + a(this).next("ul").children("li.active:nth-child(2)").find(".nagishli-option-title").text(),
                    b = b.split(" "),
                    b[1] = "en" == g ? b[1].charAt(0).toUpperCase() + b[1].substr(1) : b[1],
                    a('<span class="selected">' + b[1] + "&nbsp;" + phrases.and + b[3] + "</span>").insertAfter(a(this).children(".nl-dropdown-title"))) : !a(this).children("span.selected").length && a(this).next("ul").find("span.sign").length ? (b = a(this).next("ul").children("li.active").find(".nagishli-option-title").text(),
                    a('<span class="selected">' + b + "</span>").insertAfter(a(this).children(".nl-dropdown-title"))) : a(this).children("span.selected").remove())
            })),
            f("change", "submenus", c))
        });
        a(commons.dd + " > #NagishLiInfo > li > #NagishLiStatement, " + commons.dd + " > #NagishLiInfo > li > #NagishLiHowAccessible, " + commons.dd + " > #NagishLiInfo > li > #NagishLiKeyboardShortcutsInfo").click(function(b) {
            if ("NagishLiStatement" == b.target.id && K)
                ...
                a(document).on("keydown.nlkbnav mousedown.nlkbnav", function(b) {
                    if (a(b.target).hasClass("NagishLiOverlay") || "closeBtn" == b.target.id && 9 !== b.which && 40 !== b.which && 38 !== b.which || 27 === b.which)
                        a("#DeveloperMsg").length ? a(".NagishLiOverlay").fadeOut("fast", function() {
                            a(this).remove();
                ...
                e.on("keydown", function(a) {
                    9 !== a.which || a.shiftKey || (a.preventDefault(),
                    d.focus())
                });
        ...
        a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > span:not(.sign, .help, .nagishli-option-title)").click(function() {
            ...
            "none" != b.css("display") && (a(commons.checkmark).prependTo(a("div#NLCustomColors")),
        ...
        a(commons.dd + " > .nl-dropdown-toggle").click(function(b) {
            a(this).next("#NagishLiColors, #NagishLiDisplay", "ul").children("li.active:not(':last-child')").length ? !a(this).children("span.selected").length && a(this).next("ul").children("li.active").length ? (b = a(this).next("ul").children("li.active").find(".nagishli-option-title").text(),
            a('<span class="selected">' + b + "</span>").insertAfter(a(this).children(".nl-dropdown-title"))) : a(this).children("span.selected").remove() : a(this).next("#NagishLiHighlight", "ul").length && (!a(this).children("span.selected").length && 1 < a(this).next("ul").children("li.active").find("span.sign").length ? (b = a(this).next("ul").children("li.active:first-child").find(".nagishli-option-title").text() + " " + a(this).next("ul").children("li.active:nth-child(2)").find(".nagishli-option-title").text(),
            b = b.split(" "),
            b[1] = "en" == g ? b[1].charAt(0).toUpperCase() + b[1].substr(1) : b[1],
            a('<span class="selected">' + b[1] + "&nbsp;" + phrases.and + b[3] + "</span>").insertAfter(a(this).children(".nl-dropdown-title"))) : !a(this).children("span.selected").length && a(this).next("ul").find("span.sign").length ? (b = a(this).next("ul").children("li.active").find(".nagishli-option-title").text(),
            a('<span class="selected">' + b + "</span>").insertAfter(a(this).children(".nl-dropdown-title"))) : a(this).children("span.selected").remove())
        ...
        a(commons.dd + " > #NagishLiText > li").click(function() {
            ...
            if (1 === b.which || 13 === b.which)
                ...
                a(this).is(":first-child") ? a('<span class="sign" aria-hidden="true">&nbsp;&nbsp;&#x2795;&#xfe0e;</span>').appendTo(a(this).children("div")) : a(this).is(":nth-child(2)") && a('<span class="sign" aria-hidden="true">&nbsp;&nbsp;&#x2796;&#xfe0e;</span>').appendTo(a(this).children("div"))
        ...
        a(commons.dd + " > #NagishLiColors > li:not(.not-clickable), " + commons.dd + " > #NagishLiDisplay > li").click(function() {
            a(this).hasClass("active") ? (a(this).not("li:last-child").removeClass("active").find("span.sign").remove(),
            a(commons.checkmark).prependTo(a(this).siblings("li:last-child").addClass("active").children("div"))) : (a(this).addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
        ...
        a(commons.dd + " > #NagishLiColors > li.not-clickable").on("click change keypress.nlkbnavclk", "#NLCustomColors > ul#NLcolorPanel > li:not(#NLCloseColorPanel)", function() {
            !a(this).hasClass("selected") || a(this).children("input").is("#NLColorPicker") ? (a(this).children("input").is("#NLColorPicker") && a(this).siblings("li.selected").length ? a(this).removeClass("selected") : a(this).addClass("selected").siblings("li").removeClass("selected").closest("li.not-clickable").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
            a(this).closest("div#NLCustomColors").children("span.sign").length || a(commons.checkmark).prependTo(a(this).closest("#NLCustomColors", "div"))) : a(this).removeClass("selected").closest("#NLCustomColors", "div").find("span.sign").remove();
            a(this).attr("aria-label") != phrases.aria_select_bgcolor && a(this).attr("aria-label") != phrases.aria_select_txtcolor ? (a(this).siblings("li").removeClass("selected").closest("li.not-clickable").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
            a(this).children("input").is("#NLColorPicker") ? a(this).addClass("selected").children("input#NLColorPicker").attr("value", a("#NLColorPicker").val()) : (a(this).parent("ul[data-type='" + phrases.bg + "']").children("li[aria-label='" + phrases.clr_custom + "']").attr("aria-label", phrases.aria_select_bgcolor).css("background-color", "transparent"),
            a(this).parent("ul[data-type='" + phrases.txt + "']").children("li[aria-label='" + phrases.clr_custom + "']").attr("aria-label", phrases.aria_select_txtcolor).css("background-color", "transparent")),
            a(this).parent("ul#NLcolorPanel").data("type") === phrases.bg ? v() : v("txt")) : a(this).closest("div#NLCustomColors").children("span.sign").length && !a("body[nl-colors]").length && a(this).removeClass("selected").closest("#NLCustomColors", "div").find("span.sign").remove();
            a("body[nl-colors]").length || a("#NLCustomColors > ul#NLcolorPanel > li.selected").length || a(commons.checkmark).prependTo(a(this).closest("li.not-clickable").removeClass("active").siblings("li:last-child").addClass("active").children("div"))
        });
        ...
        a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorBlack, " + commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorWhite").click(function() {
            a(this).hasClass("active") ? a(this).removeClass("active").find("span.sign").remove() : (a(this).siblings("span").removeClass("active").find("span.sign").remove(),
        ...
        a(commons.dd + " > #NagishLiMisc > li > #NLSkipLinks > #NLSkipLinksVal").on("change", function() {
            ...
            b = void 0 === b ? "top" : b;
            if ("top" == b || "bottom" == b)
                window.scrollTo(0, "top" == b ? 0 : (document.scrollingElement || document.body).scrollHeight);
            else if ("home" == b)
                location.assign(location.protocol + "//" + location.hostname + (location.port && ":" + location.port) + "/");
            else {
                var c;
                "menu" == b ? c = document.getElementsByTagName("nav")[0] || a("*[role='navigation']")[0] || a("ul li a")[0] || a("*[class*='menu']")[0] || a("*[id*='menu']")[0] : "header" == b ? c = document.getElementsByTagName("h1")[0] || document.getElementsByTagName("h2")[0] || document.getElementsByTagName("header")[0] || a("*[role='banner']")[0] || document.getElementsByTagName("div")[0] || document.getElementsByTagName("body")[0] : "paragraph" == b ? c = document.getElementsByTagName("p")[0] || document.getElementsByTagName("body")[0] : "content" == b && (c = document.getElementsByTagName("main")[0] || document.getElementsByTagName("article")[0] || document.getElementsByTagName("section")[0] || document.getElementsByTagName("h2")[0] || document.getElementsByTagName("h3")[0] || document.getElementsByTagName("p")[0] || document.getElementsByTagName("div")[0] || document.getElementsByTagName("body")[0]);
                c.scrollIntoView();
